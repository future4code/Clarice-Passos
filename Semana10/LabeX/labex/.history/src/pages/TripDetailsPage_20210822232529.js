...
export const DetalhesViagem = () => {
    ...
    const url = `https://us-central1-labenu-apis.cloudfunctions.net/labeX/clarice-passos-lovelace/trips/${params.id}/candidates/${candidateId}/decide`
    ...
    const listaCandidatos = viagem && viagem.trip.candidates.map(candidate =>{
